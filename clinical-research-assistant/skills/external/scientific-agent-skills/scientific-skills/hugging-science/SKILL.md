...
description: Use for AI/ML work in scientific domains such as biology, chemistry, physics, astronomy, climate, genomics, materials science, medicine, ecology, engineering, drug discovery, protein design, single-cell analysis, and scientific reasoning. Helps discover and use Hugging Science catalog resources, Hugging Face datasets/models, inference APIs, and Spaces for scientific ML tasks.
metadata:
